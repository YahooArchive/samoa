...
public class FIMTDDNumericAttributeClassObserver extends BinaryTreeNumericAttributeClassObserver implements NumericAttributeClassObserver {
	...
	rightTotal -= currentNode.leftStatistics.getValue(0);
        ...
        double[][] postSplitDists = new double[][]{{currentNode.leftStatistics.getValue(0), sumTotalLeft, sumSqTotalLeft},{rightTotal, sumTotalRight, sumSqTotalRight}};
        double[] preSplitDist = new double[]{(currentNode.leftStatistics.getValue(0)+rightTotal), (sumTotalLeft+sumTotalRight), (sumSqTotalLeft+sumSqTotalRight)};
