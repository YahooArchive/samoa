...
import com.yahoo.labs.samoa.learners.clusterers.ClusteringEvaluatorProcessor;
import com.yahoo.labs.samoa.learners.clusterers.ClusteringSourceProcessor;
import com.yahoo.labs.samoa.learners.clusterers.ClusteringSourceTopologyStarter;
...
public class ClusteringEvaluation implements Task, Configurable {
    ...
    public void init() {
        ...
        learner.getInputProcessingItem().connectInputShuffleStream(sourcePiOutputStream);
